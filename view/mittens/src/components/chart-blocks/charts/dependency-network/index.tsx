    ...
    return (
      <React.Fragment key={node.id}>
        ...
        >
          ...
          <td className="py-4 px-6 text-center">
            <div className="flex items-center justify-center">
              <span className="inline-flex items-center justify-center w-10 h-8 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800/30 dark:to-gray-700/30 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-bold border border-gray-200 dark:border-gray-600/50 shadow-sm">
                {connectionCount}
              </span>
            </div>
          </td>
